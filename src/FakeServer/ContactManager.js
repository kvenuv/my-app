...
class ContactManager extends React.Component {
    ...
    handleDelete = (e, keyid) => {
        axios.delete(`http://localhost:3000/ContactDetails/${keyid}`)
            .then((res) => {
    ...
    render() {
        return (
            <>
                <form>
                    Contact Name: <input type="text" placeholder="enter the name of the contact" onChange={(e) => this.handleChange(e, "contactname")} />
                    Contact Mail: <input type="text" placeholder="Email" onChange={(e) => this.handleChange(e, "contactemail")} />
                    Contact Number: <input type="text" placeholder="Phone" onChange={(e) => this.handleChange(e, "contactnumber")} />
